...
export default function MyComponent() {
  ...
  return <Avatar style={{ width: '100px', height: '100px' }} {...randomProps} />
}
```
...
<link
  rel="stylesheet"
  href="node_modules/@firepenguindisopanda/avataaars/dist/animations.css"
/>
```
...
export default function MyComponent() {
  ...
  return <Avatar style={{ width: '100px', height: '100px' }} {...config} />
}
```

_Note: Dynamically runtime-registered custom colors or gradients will receive higher indices. If they exist in a future run, they will map correctly; otherwise, they will gracefully fallback to their category defaults._
...
| Value         | Icon                                                  | Value            | Icon                                                        | Value             | Icon                                                          |
| ------------- | ----------------------------------------------------- | ---------------- | ----------------------------------------------------------- | ----------------- | ------------------------------------------------------------- |
| `Blank`       | _(None)_                                              | `BeardLight`     | ![BeardLight](docs/icons/facialHair/BeardLight.svg)         | `BeardMajestic`   | ![BeardMajestic](docs/icons/facialHair/BeardMajestic.svg)     |
