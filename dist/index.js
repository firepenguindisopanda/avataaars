...
var Skin = class extends React8.Component {
  render() {
    return /* @__PURE__ */ React8.createElement(Selector_default, { option: SkinOption, defaultOption: "Light" }, Array.from(skinColorPalette.values()).map((ColorComponent, index) => /* @__PURE__ */ React8.createElement(ColorComponent, { key: index, uid: this.props.uid })));
  }
};
