...
var FacialHair = class extends React2.Component {
  render() {
    return /* @__PURE__ */ React2.createElement(Selector_default, { option: FacialHairOption, defaultOption: Blank }, /* @__PURE__ */ React2.createElement(Blank, { uid: this.props.uid }), /* @__PURE__ */ React2.createElement(BeardMedium, { uid: this.props.uid }), /* @__PURE__ */ React2.createElement(BeardLight, { uid: this.props.uid }), /* @__PURE__ */ React2.createElement(BeardMajestic, { uid: this.props.uid }), /* @__PURE__ */ React2.createElement(MoustacheFancy, { uid: this.props.uid }), /* @__PURE__ */ React2.createElement(MoustacheMagnum, { uid: this.props.uid }));
  }
};
...
var Skin = class extends import_react4.default.Component {
  render() {
    return /* @__PURE__ */ import_react4.default.createElement(Selector_default, { option: SkinOption, defaultOption: "Light" }, Array.from(skinColorPalette.values()).map((ColorComponent, index) => /* @__PURE__ */ import_react4.default.createElement(ColorComponent, { key: index, uid: this.props.uid })));
  }
};
