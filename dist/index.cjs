...
var BackdropOption = new Option({
  key: "backdropType",
  label: "Backdrop"
});
var BackdropColorOption = new Option({
  key: "backdropColor",
  label: "\u{1F535} BackdropColor"
});
var TopOption = new Option({
  key: "topType",
  label: "Top"
});
var AccessoriesOption = new Option({
  key: "accessoriesType",
  label: "\u21B3 \u{1F453} Accessories"
});
var HatColorOption = new Option({
  key: "hatColor",
  label: "\u{1F3A8} HatColor"
});
var HairColorOption = new Option({
  key: "hairColor",
  label: "\u21B3 \u{1F488} Hair Color"
});
var FacialHairOption = new Option({
  key: "facialHairType",
  label: "Facial Hair"
});
var FacialHairColorOption = new Option({
  key: "facialHairColor",
  label: "\u21B3 \u2702\uFE0F Facial Hair Color"
});
var ClotheOption = new Option({
  key: "clotheType",
  label: "\u{1F454} Clothes"
});
var ClotheColorOption = new Option({
  key: "clotheColor",
  label: "\u21B3 Color Fabric"
});
var GraphicOption = new Option({
  key: "graphicType",
  label: "\u21B3 Graphic"
});
var EyesOption = new Option({
  key: "eyeType",
  label: "\u{1F441} Eyes"
});
var EyebrowOption = new Option({
  key: "eyebrowType",
  label: "\u270F\uFE0F Eyebrow"
});
var MouthOption = new Option({
  key: "mouthType",
  label: "\u{1F444} Mouth"
});
var SkinOption = new Option({
  key: "skinColor",
  label: "\u{1F3A8} Skin"
});
var allOptions = [
...
var BeardLight = makeOptionComponent("FACIAL_HAIR", "BeardLight");
var BeardMajestic = makeOptionComponent("FACIAL_HAIR", "BeardMajestic");
var BeardMedium = makeOptionComponent("FACIAL_HAIR", "BeardMedium");
var MoustacheFancy = makeOptionComponent("FACIAL_HAIR", "MoustacheFancy");
var MoustacheMagnum = makeOptionComponent("FACIAL_HAIR", "MoustacheMagnum");
var FacialHair = class extends React2.Component {
  render() {
    return /* @__PURE__ */ React2.createElement(Selector_default, { option: FacialHairOption, defaultOption: BeardLight }, /* @__PURE__ */ React2.createElement(Blank, { uid: this.props.uid }), /* @__PURE__ */ React2.createElement(BeardMedium, { uid: this.props.uid }), /* @__PURE__ */ React2.createElement(BeardLight, { uid: this.props.uid }), /* @__PURE__ */ React2.createElement(BeardMajestic, { uid: this.props.uid }), /* @__PURE__ */ React2.createElement(MoustacheFancy, { uid: this.props.uid }), /* @__PURE__ */ React2.createElement(MoustacheMagnum, { uid: this.props.uid }));
  }
};
  ...
  class ColorComponent extends React3.Component {
    render() {
      ...
      return /* @__PURE__ */ React3.createElement(
        ...
        /* @__PURE__ */ React3.createElement("g", { transform: "translate(0.000000, 0.000000) ", id: "Color" }, /* @__PURE__ */ React3.createElement("rect", { x: "0", y: "0", width: "264", height: "280" }))
      );
    }
  }
...
var HairColor = class extends React3.Component {
  render() {
    return /* @__PURE__ */ React3.createElement(Selector_default, { option: HairColorOption, defaultOption: "Black" }, Array.from(hairColorPalette.values()).map((ColorComponent, index) => /* @__PURE__ */ React3.createElement(ColorComponent, { key: index, uid: this.props.uid })));
  }
};
...
anyBlank2.optionValue = "Blank";
var Kurt = makeOptionComponent("ACCESSORIES", "Kurt");
var Prescription01 = makeOptionComponent("ACCESSORIES", "Prescription01");
var Prescription02 = makeOptionComponent("ACCESSORIES", "Prescription02");
  ...
  class ColorComponent extends React6.Component {
    render() {
      ...
      return /* @__PURE__ */ React6.createElement(
        ...
        /* @__PURE__ */ React6.createElement("rect", { id: `${this.props.uid}-\u{1F58D}Color`, x: "0", y: "0", width: "264", height: "110" })
      );
    }
  }
  const anyComponent = ColorComponent;
...
var ClotheColor = class extends React6.Component {
  render() {
    return /* @__PURE__ */ React6.createElement(Selector_default, { option: ClotheColorOption, defaultOption: "Gray01" }, Array.from(clotheColorPalette.values()).map((ColorComponent, index) => /* @__PURE__ */ React6.createElement(ColorComponent, { key: index, uid: this.props.uid })));
  }
};
  ...
  class ColorComponent extends React7.Component {
    render() {
      ...
      return /* @__PURE__ */ React7.createElement(
        ...
        /* @__PURE__ */ React7.createElement("rect", { id: `${this.props.uid}-\u{1F58D}Color`, x: "0", y: "0", width: "264", height: "280" })
      );
    }
  }
  const anyComponent = ColorComponent;
...
var Colors = class extends React7.Component {
  render() {
    return /* @__PURE__ */ React7.createElement(Selector_default, { option: HatColorOption, defaultOption: this.props.defaultColor || "Gray01" }, Array.from(hatColorPalette.values()).map((ColorComponent, index) => /* @__PURE__ */ React7.createElement(ColorComponent, { key: index, uid: this.props.uid })));
  }
};
...
var Cumbia = makeOptionComponent("CLOTHES", "Cumbia");
var Deer = makeOptionComponent("CLOTHES", "Deer");
var Diamond = makeOptionComponent("CLOTHES", "Diamond");
var Hola = makeOptionComponent("CLOTHES", "Hola");
var Selena = makeOptionComponent("CLOTHES", "Selena");
  ...
  class ColorComponent extends React10.Component {
    render() {
      ...
      return /* @__PURE__ */ React10.createElement(
        ...
        /* @__PURE__ */ React10.createElement("g", { transform: "translate(-32.000000, 0.000000)", id: `${this.props.uid}-Facial-Hair-Color` }, /* @__PURE__ */ React10.createElement("rect", { x: "0", y: "0", width: "264", height: "244" }))
      );
    }
  }
  const anyComponent = ColorComponent;
...
var FacialHairColor = class extends React10.Component {
  render() {
    return /* @__PURE__ */ React10.createElement(Selector_default, { option: FacialHairColorOption, defaultOption: "BrownDark" }, Array.from(facialHairColorPalette.values()).map((ColorComponent, index) => /* @__PURE__ */ React10.createElement(ColorComponent, { key: index, uid: this.props.uid })));
  }
};

// src/avatar/SvgDictionaryRenderer.tsx
var SvgDictionaryRenderer = (props) => {
...
var SvgDictionaryRenderer_default = SvgDictionaryRenderer;

// src/avatar/svgDictionary.ts
var SVG_DICTIONARY = {
  "BACKDROP": {
    "Circle": {
      "type": "",
  ...
  "EYES": {
    ...
    "WinkWacky": {
      "type": "g",
      "props": {
        "id": "{uid}-Eyes/Wink-Wacky-\u{1F61C}",
        "transform": "translate(0.000000, 8.000000)"
      },
      "children": [
        {
...
// src/avatar/makeOptionComponent.tsx
function makeOptionComponent(category, name) {
...
var GraphicShirt = makeOptionComponent("CLOTHES", "GraphicShirt");
var Hoodie = makeOptionComponent("CLOTHES", "Hoodie");
var Overall = makeOptionComponent("CLOTHES", "Overall");
...
var DefaultNatural = makeOptionComponent("EYEBROW", "DefaultNatural");
var FlatNatural = makeOptionComponent("EYEBROW", "FlatNatural");
var RaisedExcited = makeOptionComponent("EYEBROW", "RaisedExcited");
var RaisedExcitedNatural = makeOptionComponent("EYEBROW", "RaisedExcitedNatural");
var SadConcerned = makeOptionComponent("EYEBROW", "SadConcerned");
var SadConcernedNatural = makeOptionComponent("EYEBROW", "SadConcernedNatural");
var UnibrowNatural = makeOptionComponent("EYEBROW", "UnibrowNatural");
var UpDown = makeOptionComponent("EYEBROW", "UpDown");
var UpDownNatural = makeOptionComponent("EYEBROW", "UpDownNatural");
var Eyebrow = class extends React15.Component {
  render() {
    return /* @__PURE__ */ React15.createElement(Selector_default, { defaultOption: Default, option: EyebrowOption }, /* @__PURE__ */ React15.createElement(Angry, { uid: this.props.uid }), /* @__PURE__ */ React15.createElement(AngryNatural, { uid: this.props.uid }), /* @__PURE__ */ React15.createElement(Default, { uid: this.props.uid }), /* @__PURE__ */ React15.createElement(DefaultNatural, { uid: this.props.uid }), /* @__PURE__ */ React15.createElement(FlatNatural, { uid: this.props.uid }), /* @__PURE__ */ React15.createElement(RaisedExcited, { uid: this.props.uid }), /* @__PURE__ */ React15.createElement(RaisedExcitedNatural, { uid: this.props.uid }), /* @__PURE__ */ React15.createElement(SadConcerned, { uid: this.props.uid }), /* @__PURE__ */ React15.createElement(SadConcernedNatural, { uid: this.props.uid }), /* @__PURE__ */ React15.createElement(UnibrowNatural, { uid: this.props.uid }), /* @__PURE__ */ React15.createElement(UpDown, { uid: this.props.uid }), /* @__PURE__ */ React15.createElement(UpDownNatural, { uid: this.props.uid }));
  }
};
...
var Dizzy = makeOptionComponent("EYES", "Dizzy");
var EyeRoll = makeOptionComponent("EYES", "EyeRoll");
var Happy = makeOptionComponent("EYES", "Happy");
var Hearts = makeOptionComponent("EYES", "Hearts");
var Side = makeOptionComponent("EYES", "Side");
var Squint = makeOptionComponent("EYES", "Squint");
var Surprised = makeOptionComponent("EYES", "Surprised");
var Wink = makeOptionComponent("EYES", "Wink");
var WinkWacky = makeOptionComponent("EYES", "WinkWacky");
var Eyes = class extends React16.Component {
  render() {
    return /* @__PURE__ */ React16.createElement(Selector_default, { defaultOption: Default2, option: EyesOption }, /* @__PURE__ */ React16.createElement(Close, { uid: this.props.uid }), /* @__PURE__ */ React16.createElement(Cry, { uid: this.props.uid }), /* @__PURE__ */ React16.createElement(Default2, { uid: this.props.uid }), /* @__PURE__ */ React16.createElement(Dizzy, { uid: this.props.uid }), /* @__PURE__ */ React16.createElement(EyeRoll, { uid: this.props.uid }), /* @__PURE__ */ React16.createElement(Happy, { uid: this.props.uid }), /* @__PURE__ */ React16.createElement(Hearts, { uid: this.props.uid }), /* @__PURE__ */ React16.createElement(Side, { uid: this.props.uid }), /* @__PURE__ */ React16.createElement(Squint, { uid: this.props.uid }), /* @__PURE__ */ React16.createElement(Surprised, { uid: this.props.uid }), /* @__PURE__ */ React16.createElement(Wink, { uid: this.props.uid }), /* @__PURE__ */ React16.createElement(WinkWacky, { uid: this.props.uid }));
  }
};
...
var Eating = makeOptionComponent("MOUTH", "Eating");
var SideChew = makeOptionComponent("MOUTH", "SideChew");
var SideSmile = makeOptionComponent("MOUTH", "SideSmile");
var Whistling = makeOptionComponent("MOUTH", "Whistling");
var Grimace = makeOptionComponent("MOUTH", "Grimace");
var Sad = makeOptionComponent("MOUTH", "Sad");
var ScreamOpen = makeOptionComponent("MOUTH", "ScreamOpen");
var Serious = makeOptionComponent("MOUTH", "Serious");
var Smile = makeOptionComponent("MOUTH", "Smile");
var Tongue = makeOptionComponent("MOUTH", "Tongue");
var Twinkle = makeOptionComponent("MOUTH", "Twinkle");
var Vomit = makeOptionComponent("MOUTH", "Vomit");
var Mouth = class extends React17.Component {
  render() {
    return /* @__PURE__ */ React17.createElement(Selector_default, { defaultOption: Default3, option: MouthOption }, /* @__PURE__ */ React17.createElement(Concerned, { uid: this.props.uid }), /* @__PURE__ */ React17.createElement(Default3, { uid: this.props.uid }), /* @__PURE__ */ React17.createElement(Disbelief, { uid: this.props.uid }), /* @__PURE__ */ React17.createElement(Eating, { uid: this.props.uid }), /* @__PURE__ */ React17.createElement(SideChew, { uid: this.props.uid }), /* @__PURE__ */ React17.createElement(SideSmile, { uid: this.props.uid }), /* @__PURE__ */ React17.createElement(Whistling, { uid: this.props.uid }), /* @__PURE__ */ React17.createElement(Grimace, { uid: this.props.uid }), /* @__PURE__ */ React17.createElement(Sad, { uid: this.props.uid }), /* @__PURE__ */ React17.createElement(ScreamOpen, { uid: this.props.uid }), /* @__PURE__ */ React17.createElement(Serious, { uid: this.props.uid }), /* @__PURE__ */ React17.createElement(Smile, { uid: this.props.uid }), /* @__PURE__ */ React17.createElement(Tongue, { uid: this.props.uid }), /* @__PURE__ */ React17.createElement(Twinkle, { uid: this.props.uid }), /* @__PURE__ */ React17.createElement(Vomit, { uid: this.props.uid }));
  }
};

// src/avatar/face/nose/Default.tsx
var Default_default = makeOptionComponent("NOSE", "Default");

// src/avatar/face/index.tsx
var Face = class extends React18.Component {
  render() {
    return /* @__PURE__ */ React18.createElement("g", { id: `${this.props.uid}-Face`, transform: "translate(76.000000, 82.000000)", fill: "#000000" }, /* @__PURE__ */ React18.createElement(Mouth, { uid: this.props.uid }), /* @__PURE__ */ React18.createElement(Default_default, { uid: this.props.uid }), /* @__PURE__ */ React18.createElement(Eyes, { uid: this.props.uid }), /* @__PURE__ */ React18.createElement(Eyebrow, { uid: this.props.uid }));
  }
};
...
var LongHairBigHair = makeOptionComponent("TOP", "LongHairBigHair");
var LongHairBob = makeOptionComponent("TOP", "LongHairBob");
var LongHairBun = makeOptionComponent("TOP", "LongHairBun");
var LongHairCurly = makeOptionComponent("TOP", "LongHairCurly");
var LongHairCurvy = makeOptionComponent("TOP", "LongHairCurvy");
var LongHairDreads = makeOptionComponent("TOP", "LongHairDreads");
var LongHairFrida = makeOptionComponent("TOP", "LongHairFrida");
var LongHairFro = makeOptionComponent("TOP", "LongHairFro");
var LongHairFroBand = makeOptionComponent("TOP", "LongHairFroBand");
var LongHairMiaWallace = makeOptionComponent("TOP", "LongHairMiaWallace");
var LongHairNotTooLong = makeOptionComponent("TOP", "LongHairNotTooLong");
var LongHairShavedSides = makeOptionComponent("TOP", "LongHairShavedSides");
var LongHairStraight = makeOptionComponent("TOP", "LongHairStraight");
var LongHairStraight2 = makeOptionComponent("TOP", "LongHairStraight2");
var LongHairStraightStrand = makeOptionComponent("TOP", "LongHairStraightStrand");
var NoHair = makeOptionComponent("TOP", "NoHair");
var ShortHairDreads01 = makeOptionComponent("TOP", "ShortHairDreads01");
var ShortHairDreads02 = makeOptionComponent("TOP", "ShortHairDreads02");
var ShortHairFrizzle = makeOptionComponent("TOP", "ShortHairFrizzle");
var ShortHairShaggy = makeOptionComponent("TOP", "ShortHairShaggy");
var ShortHairShaggyMullet = makeOptionComponent("TOP", "ShortHairShaggyMullet");
var ShortHairShortCurly = makeOptionComponent("TOP", "ShortHairShortCurly");
var ShortHairShortFlat = makeOptionComponent("TOP", "ShortHairShortFlat");
var ShortHairShortRound = makeOptionComponent("TOP", "ShortHairShortRound");
var ShortHairShortWaved = makeOptionComponent("TOP", "ShortHairShortWaved");
var ShortHairSides = makeOptionComponent("TOP", "ShortHairSides");
var ShortHairTheCaesar = makeOptionComponent("TOP", "ShortHairTheCaesar");
var ShortHairTheCaesarSidePart = makeOptionComponent("TOP", "ShortHairTheCaesarSidePart");
var Turban = makeOptionComponent("TOP", "Turban");
var WinterHat1 = makeOptionComponent("TOP", "WinterHat1");
    ...
    /* @__PURE__ */ import_react8.default.createElement("defs", null, /* @__PURE__ */ import_react8.default.createElement(
      ...
      return /* @__PURE__ */ import_react8.default.createElement(Tag, { key: gradName, id, ...config.attrs }, config.stops.map((stop, i) => /* @__PURE__ */ import_react8.default.createElement(
        "stop",
        {
          ...
          stopOpacity: stop.opacity !== void 0 ? stop.opacity : void 0
        }
      )));
    })),
...
var PieceComponent = (props) => {
  ...
  return /* @__PURE__ */ React21.createElement(
    ...
    pieceType === "top" && /* @__PURE__ */ React21.createElement(Top, { uid }),
    pieceType === "clothe" && /* @__PURE__ */ React21.createElement(Clothes, { uid }),
    pieceType === "graphics" && /* @__PURE__ */ React21.createElement(Graphics, { uid }),
    (pieceType === "accessories" || pieceType === "accesories") && /* @__PURE__ */ React21.createElement(Accessories, { uid }),
    pieceType === "facialHair" && /* @__PURE__ */ React21.createElement(FacialHair, { uid }),
    pieceType === "eyes" && /* @__PURE__ */ React21.createElement(Eyes, { uid }),
    pieceType === "eyebrows" && /* @__PURE__ */ React21.createElement(Eyebrow, { uid }),
    pieceType === "mouth" && /* @__PURE__ */ React21.createElement(Mouth, { uid }),
    pieceType === "nose" && /* @__PURE__ */ React21.createElement(Default_default, { uid }),
    pieceType === "skin" && /* @__PURE__ */ React21.createElement(Skin, { uid })
  );
};
var piece_default = PieceComponent;
